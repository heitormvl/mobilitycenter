        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                EXCEPTION WHEN insufficient_privilege THEN
                    -- PostGIS já instalado pelo administrador (ex: Supabase dashboard)
                    NULL;
                END $$;
            ");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bicicletarios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Bicicletarios_AspNetUsers_OperadorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Avaliacoes_Bicicletarios_BicicletarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Avaliacoes_BicicletarioId",
                table: "Avaliacoes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bicicletarios_Location",
                table: "Bicicletarios",
                column: "Location")
                .Annotation("Npgsql:IndexMethod", "gist");

            migrationBuilder.CreateIndex(
                name: "IX_Bicicletarios_OperadorId",
                table: "Bicicletarios",
                column: "OperadorId");
        }
